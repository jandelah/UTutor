...
const Mentorships = () => {
  ...
  const fetchMentorships = async () => {
    try {
      ...
      setError("Error al cargar las mentorías. Inténtalo de nuevo más tarde.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleEndMentorship = async (mentorshipId) => {
    try {
      ...
      setSnackbar({
        open: true,
        message: 'Mentoría finalizada correctamente',
        severity: 'success'
      });
      ...
      setSnackbar({
        open: true,
        message: 'Error al finalizar la mentoría',
        severity: 'error'
      });
    }
  };
  ...
  const handleCancelMentorship = async (mentorshipId) => {
    try {
      ...
      setSnackbar({
        open: true,
        message: 'Mentoría cancelada correctamente',
        severity: 'success'
      });
      ...
      setSnackbar({
        open: true,
        message: 'Error al cancelar la mentoría',
        severity: 'error'
      });
    }
  };
  ...
  if (loading) {
    return <LoadingSpinner message="Cargando mentorías..." />;
  }
  ...
  return (
    <Container maxWidth="lg">
      <PageHeader 
        ...
        breadcrumbs={[{ text: 'Mis Mentorías', link: '/tutoring' }]}
      />
      ...
      >
        {selectedMentorship && (
          <>
            <DialogTitle>
              Detalles de Mentoría con {selectedMentorship.tutor?.name}
            </DialogTitle>

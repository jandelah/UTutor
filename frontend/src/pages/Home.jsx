    ...
    <>
        ...
        <Container maxWidth="lg">
          <Grid container spacing={4} alignItems="center">
            ...
            <Grid item xs={12} md={5}>
              <Box 
                component="img"
                src="https://placehold.co/600x400/12a778/FFFFFF?text=UTutor SJR"
      ...
      <Container maxWidth="lg" sx={{ mb: 6 }}>
        ...
        <Typography 
          ...
          sx={{ mb: 6 }}
        >
          Descubre todo lo que UTutor SJR puede ofrecerte
        </Typography>
            ...
            <Grid item xs={12} md={4}>
              <Card sx={{ height: '100%' }}>
                ...
                <CardContent>
                  ...
                  <Typography variant="body1">
                    Busca mentores o tutorados según tus necesidades académicas.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
      ...
      <Container maxWidth="md" sx={{ mb: 6 }}>
        ...
        >
          ...
          <Typography variant="subtitle1" paragraph>
            Únete a UTutor SJR y forma parte de nuestra comunidad de aprendizaje colaborativo.
          </Typography>
          <Button 
            variant="contained" 
            color="primary" 
